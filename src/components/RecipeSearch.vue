<template>
  <section id="about-section">
    <div class="menu-container">
      <div class="about-text">
        <div>
          ...
          >Mainly developed this project to learn the basics of the framework and creating a responsive design.</p>
          <p style="font-weight:500; margin-top:10px;">
            Using an API from
            <a class="link" href="https://www.edamam.com/">Edamam</a> the user can search recipes and tick off ingredients from each recipe.
          </p>
          <p style="font-weight:500; margin-top:10px;">
            Either visit the recipe search
            <a class="link" href="https://stanggren.github.io/recipe-api/">website</a> or check out the GitHub
            <a class="link" href="https://github.com/stanggren/recipe-api">repo</a>.
          </p>
          <p
            @click="showModal = true"
            class="modal-click show-image link"
            id="show-image"
          >Show image</p>
        </div>
    ...
    <div class="content-container">
      <div>
        <img rel="preload" src="../assets/recipesearch.png" alt="Dashboard 1" />
      </div>
    ...
    <transition name="modalFade" appear>
      <div class="modal" v-if="showModal">
        <div>
          <img src="../assets/recipesearch.png" alt="Dashboard 1" />
        </div>
      </div>
    </transition>
  </section>

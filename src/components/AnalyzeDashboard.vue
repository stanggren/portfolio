<template>
  <section id="about-section">
      ...
      <div class="about-text">
        <div>
          ...
          <p id="header">
            ...
            <a class="link" href="https://www.visitgroup.com/">Visit Group</a> I got the opportunity to build a dashboard.
          </p>
          <p
          ...
          <p
            style="font-weight:500; margin-top:10px;"
          >The analyze dashboard went in to production in December 2019 and is being used both by employees and customers of Visit Group.</p>
          <p
            style="font-weight:500; margin-top:10px;"
          >My time at Visit Group and working on this project has given me good insight in customer based development within an agile workflow.</p>
    ...
    <div class="content-container">
      <div>
        <img rel="preload" src="../assets/dashboard-1.jpg" alt="Dashboard 1" />
      </div>
    ...
    <transition name="modalFade" appear>
      <div class="modal" v-if="showModal">
        <div>
          <img src="../assets/dashboard-1.jpg" alt="Dashboard 1" />
        </div>
      </div>
    </transition>
  </section>
